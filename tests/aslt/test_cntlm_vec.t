  ...
  bits ( 64 ) result__4 ;
  __array _Z [ 0 ] = ZeroExtend.0 {{ 64,128 }} ( Elem.set.0 {{ 64,32 }} ( Elem.set.0 {{ 64,32 }} ( result__4,0,32,lsr_bits.0 {{ 32 }} ( Elem.read.0 {{ 64,32 }} ( __array _Z [ 0 ] [ 0 +: 64 ],0,32 ),'00000000000000000000000000011000' ) ),1,32,lsr_bits.0 {{ 32 }} ( Elem.read.0 {{ 64,32 }} ( __array _Z [ 0 ] [ 0 +: 64 ],1,32 ),'00000000000000000000000000011000' ) ),128 ) ;
  "0x2f280424"
  Decoding instruction A64 2f280424
  bits ( 64 ) result__4 ;
  __array _Z [ 4 ] = ZeroExtend.0 {{ 64,128 }} ( Elem.set.0 {{ 64,32 }} ( Elem.set.0 {{ 64,32 }} ( result__4,0,32,lsr_bits.0 {{ 32 }} ( Elem.read.0 {{ 64,32 }} ( __array _Z [ 1 ] [ 0 +: 64 ],0,32 ),'00000000000000000000000000011000' ) ),1,32,lsr_bits.0 {{ 32 }} ( Elem.read.0 {{ 64,32 }} ( __array _Z [ 1 ] [ 0 +: 64 ],1,32 ),'00000000000000000000000000011000' ) ),128 ) ;
  "0x2f300423"
  Decoding instruction A64 2f300423
  bits ( 64 ) result__4 ;
  __array _Z [ 3 ] = ZeroExtend.0 {{ 64,128 }} ( Elem.set.0 {{ 64,32 }} ( Elem.set.0 {{ 64,32 }} ( result__4,0,32,lsr_bits.0 {{ 32 }} ( Elem.read.0 {{ 64,32 }} ( __array _Z [ 1 ] [ 0 +: 64 ],0,32 ),'00000000000000000000000000010000' ) ),1,32,lsr_bits.0 {{ 32 }} ( Elem.read.0 {{ 64,32 }} ( __array _Z [ 1 ] [ 0 +: 64 ],1,32 ),'00000000000000000000000000010000' ) ),128 ) ;
  "0x2f300446"
  Decoding instruction A64 2f300446
  bits ( 64 ) result__4 ;
  __array _Z [ 6 ] = ZeroExtend.0 {{ 64,128 }} ( Elem.set.0 {{ 64,32 }} ( Elem.set.0 {{ 64,32 }} ( result__4,0,32,lsr_bits.0 {{ 32 }} ( Elem.read.0 {{ 64,32 }} ( __array _Z [ 2 ] [ 0 +: 64 ],0,32 ),'00000000000000000000000000010000' ) ),1,32,lsr_bits.0 {{ 32 }} ( Elem.read.0 {{ 64,32 }} ( __array _Z [ 2 ] [ 0 +: 64 ],1,32 ),'00000000000000000000000000010000' ) ),128 ) ;
  "0x2f380422"
  Decoding instruction A64 2f380422
  bits ( 64 ) result__4 ;
  __array _Z [ 2 ] = ZeroExtend.0 {{ 64,128 }} ( Elem.set.0 {{ 64,32 }} ( Elem.set.0 {{ 64,32 }} ( result__4,0,32,lsr_bits.0 {{ 32 }} ( Elem.read.0 {{ 64,32 }} ( __array _Z [ 1 ] [ 0 +: 64 ],0,32 ),'00000000000000000000000000001000' ) ),1,32,lsr_bits.0 {{ 32 }} ( Elem.read.0 {{ 64,32 }} ( __array _Z [ 1 ] [ 0 +: 64 ],1,32 ),'00000000000000000000000000001000' ) ),128 ) ;
  "0x2f380445"
  Decoding instruction A64 2f380445
  bits ( 64 ) result__4 ;
  __array _Z [ 5 ] = ZeroExtend.0 {{ 64,128 }} ( Elem.set.0 {{ 64,32 }} ( Elem.set.0 {{ 64,32 }} ( result__4,0,32,lsr_bits.0 {{ 32 }} ( Elem.read.0 {{ 64,32 }} ( __array _Z [ 2 ] [ 0 +: 64 ],0,32 ),'00000000000000000000000000001000' ) ),1,32,lsr_bits.0 {{ 32 }} ( Elem.read.0 {{ 64,32 }} ( __array _Z [ 2 ] [ 0 +: 64 ],1,32 ),'00000000000000000000000000001000' ) ),128 ) ;
  "0x4cdf0860"
